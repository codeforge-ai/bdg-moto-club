...
import clubMembers from "@/assets/club-members.jpeg";
import heroImage from "@/assets/hero-motorcycle.jpeg";
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-lime-50">
              Despre Noi
            </h1>
